...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-200 via-orange-300 to-orange-400 px-4 lg:px-8 animate-gradient bg-noise font-inter">
      <div className="bg-white/30 p-6 md:p-10 lg:p-12 rounded-3xl shadow-2xl w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl border border-white/20 animate-fade-in-up">
        {/* Company Branding */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              autoFocus
              aria-label="Username"
              className="w-full pl-10 p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:outline-none shadow-sm transition duration-300 hover:border-orange-400 text-base lg:text-lg font-inter"
            />
            <label className="absolute left-10 -top-2 text-sm text-orange-500 bg-white px-2 font-inter">
              Username
            </label>
